...
#
reset
set term png size 2600, 3000 enhanced font "Helvetica, 24" lw 2
#set size 1,1
#set size square
...
splot [0:400][0:90] "u_t_d0.dat" u 1:2:3 i 0 notitle
...
splot [0:400][0:90] "u_t_d01.dat" u 1:2:3 i 0 notitle
...
splot [0:400][0:90] "u_t_d0.dat" u 1:2:3 i 2 notitle
...
splot [0:400][0:90] "u_t_d01.dat" u 1:2:3 i 2 notitle
...
splot [0:400][0:90] "u_t_d0.dat" u 1:2:3 i 4 notitle
...
splot [0:400][0:90] "u_t_d01.dat" u 1:2:3 i 4 notitle
